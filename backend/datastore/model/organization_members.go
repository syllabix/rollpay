...
type OrganizationMember struct {
	...
	R *organizationMemberR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L organizationMemberL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var OrganizationMemberWhere = struct {
	...
	UserID:         whereHelperint64{field: "\"organization_members\".\"user_id\""},
	OrganizationID: whereHelperint64{field: "\"organization_members\".\"organization_id\""},
	Role:           whereHelperstring{field: "\"organization_members\".\"role\""},
	CreatedAt:      whereHelpertime_Time{field: "\"organization_members\".\"created_at\""},
	UpdatedAt:      whereHelpertime_Time{field: "\"organization_members\".\"updated_at\""},
	DeletedAt:      whereHelpernull_Time{field: "\"organization_members\".\"deleted_at\""},
}
...
var (
	organizationMemberAllColumns            = []string{"user_id", "organization_id", "role", "created_at", "updated_at", "deleted_at"}
	organizationMemberColumnsWithoutDefault = []string{"user_id", "organization_id", "role", "deleted_at"}
	organizationMemberColumnsWithDefault    = []string{"created_at", "updated_at"}
...
func (q organizationMemberQuery) One(ctx context.Context, exec boil.ContextExecutor) (*OrganizationMember, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for organization_members")
	}
...
func (q organizationMemberQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrganizationMemberSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to OrganizationMember slice")
	}
...
func (q organizationMemberQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count organization_members rows")
	}
...
func (q organizationMemberQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if organization_members exists")
	}
...
func OrganizationMembers(mods ...qm.QueryMod) organizationMemberQuery {
	mods = append(mods, qm.From("\"organization_members\""), qmhelper.WhereIsNull("\"organization_members\".\"deleted_at\""))
...
func FindOrganizationMember(ctx context.Context, exec boil.ContextExecutor, userID int64, organizationID int64, selectCols ...string) (*OrganizationMember, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"organization_members\" where \"user_id\"=$1 AND \"organization_id\"=$2 and \"deleted_at\" is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from organization_members")
	}
...
func (o *OrganizationMember) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no organization_members provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into organization_members")
	}
...
func (o *OrganizationMember) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update organization_members, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update organization_members row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for organization_members")
	}
...
func (q organizationMemberQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for organization_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for organization_members")
	}
...
func (o OrganizationMemberSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in organizationMember slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all organizationMember")
	}
	return rowsAff, nil
}
...
func (o *OrganizationMember) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no organization_members provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert organization_members, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert organization_members")
	}
...
func (o *OrganizationMember) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no OrganizationMember provided for delete")
	}
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"organization_members\" SET %s WHERE \"user_id\"=$2 AND \"organization_id\"=$3",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
		valueMapping, err := queries.BindMapping(organizationMemberType, organizationMemberMapping, append(wl, organizationMemberPrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from organization_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for organization_members")
	}
...
func (q organizationMemberQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no organizationMemberQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from organization_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for organization_members")
	}
...
func (o OrganizationMemberSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"organization_members\" SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 2, organizationMemberPrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from organizationMember slice")
	}
...
func (o *OrganizationMemberSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in OrganizationMemberSlice")
	}
...
func OrganizationMemberExists(ctx context.Context, exec boil.ContextExecutor, userID int64, organizationID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"organization_members\" where \"user_id\"=$1 AND \"organization_id\"=$2 and \"deleted_at\" is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if organization_members exists")
	}
