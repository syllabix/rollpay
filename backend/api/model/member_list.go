...
func (m *MemberList) validateResults(formats strfmt.Registry) error {
...
func (m *MemberList) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
